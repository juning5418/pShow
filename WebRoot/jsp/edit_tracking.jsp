...
<body>
	<div class="pageContent">
		<form method="post" action="edit_tracking"
			class="pageForm required-validate"
			onsubmit="return validateCallback(this, navTabAjaxDone);">
			<input type="hidden" value="${tracking.projectId}" name="projectId">
			<input type="hidden" value="${tracking.id}" name="id">
			<div class="pageFormContent nowrap" layoutH="56">
				<dl id="title_div">
					<dt>标题：</dt>
					<dd>
						<input name="title" class="required" maxlength="25"
							type="text"  id="title"  value="${tracking.title}"/>
					</dd>
				</dl>
				<dl id="textDesc_div">
					<dt>内容：</dt>
					<dd>
						<textarea rows="2" cols="100" name="content" maxlength="200">${tracking.content}</textarea>
					</dd>
				</dl>
			</div>
			<div class="formBar">
